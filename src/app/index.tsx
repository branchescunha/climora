...
export default function App() {
  ...
  const handleLocation = async () => {
    ...
    if (!locationResult.success) {
      ...
      const weatherResult = await getCurrentWeatherByCoords(
        latitude,
        longitude,
      );
    ...
    <SafeAreaView style={homeStyles.safeArea}>
      ...
      <ScrollView style={homeStyles.container}>
        <View style={homeStyles.header}>
          <Text style={homeStyles.title}>Climora</Text>
          <Text style={homeStyles.subtitle}>
            Fique por dentro do clima em qualquer lugar do mundo!
          </Text>
        </View>
        ...
        <View style={homeStyles.emptyContainer}>
          <Text style={homeStyles.emptyText}>Digite o nome do local</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
